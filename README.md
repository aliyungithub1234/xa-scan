...
| **Most Flexible** | ✅ Works with any LLM (OpenAI, Anthropic, DeepSeek, **MiniMax ⭐**, Google, Groq, Ollama, **Kimi/Moonshot**) |
...
| 🧠 **Multi-LLM** | OpenAI, Anthropic, DeepSeek, MiniMax, Groq, Ollama, Google, Kimi/Moonshot |
...
|----------|-------------|---------|
| `XALGORIX_LLM` | Model name (with optional provider prefix) | `openai/gpt-5.4`, `anthropic/claude-opus-4-1-20250805`, `deepseek/deepseek-v4-pro`, `google/gemini-3.1-pro-preview`, `minimax/MiniMax-M2.7`, `kimi/moonshot-v1-128k`, `custom/my-model` |
...
- **Kimi/Moonshot** — `kimi/moonshot-v1-128k`, `kimi/moonshot-v1-32k`, `kimi/moonshot-v1-8k` (OpenAI-compatible API)
